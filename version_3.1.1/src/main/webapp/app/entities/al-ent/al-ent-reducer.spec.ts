...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './al-ent.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ALENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ALENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ALENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ALENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ALENT actions', async () => {
      const expectedActions = [
        {
