...
export const TipoAlDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/tipo-al' + location.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="reefoodTrazabilidadAppV3App.tipoAl.delete.question">¿Seguro que quiere eliminar Tipo Al {tipoAlEntity.id}?</ModalBody>
      <ModalFooter>
