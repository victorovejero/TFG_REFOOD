...
import { getEntities, reset } from './tipo-al.reducer';
...
export const TipoAl = () => {
  ...
  const links = useAppSelector(state => state.tipoAl.links);
  const entity = useAppSelector(state => state.tipoAl.entity);
  ...
  return (
    <div>
      ...
      <div className="table-responsive">
        <InfiniteScroll
          dataLength={tipoAlList ? tipoAlList.length : 0}
          next={handleLoadMore}
                  ...
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td className="text-end">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button tag={Link} to={`/tipo-al/${tipoAl.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                          <FontAwesomeIcon icon="pencil-alt" /> <span className="d-none d-md-inline">Editar</span>
                        </Button>
                        <Button tag={Link} to={`/tipo-al/${tipoAl.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
