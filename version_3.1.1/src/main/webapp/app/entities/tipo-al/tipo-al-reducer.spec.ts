...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tipo-al.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPOAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIPOAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIPOAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIPOAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIPOAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIPOAL actions', async () => {
      const expectedActions = [
        {
