...
export const SocioDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/socio' + location.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="reefoodTrazabilidadAppV3App.socio.delete.question">¿Seguro que quiere eliminar Socio {socioEntity.id}?</ModalBody>
      <ModalFooter>
