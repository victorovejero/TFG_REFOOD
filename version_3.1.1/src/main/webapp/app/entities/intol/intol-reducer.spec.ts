...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './intol.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTOL_LIST actions', async () => {
    ...
    it('dispatches FETCH_INTOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTOL actions', async () => {
      const expectedActions = [
        {
