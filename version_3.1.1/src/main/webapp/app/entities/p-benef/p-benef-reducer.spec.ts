...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './p-benef.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PBENEF_LIST actions', async () => {
    ...
    it('dispatches FETCH_PBENEF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PBENEF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PBENEF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PBENEF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PBENEF actions', async () => {
      const expectedActions = [
        {
