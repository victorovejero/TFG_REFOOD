...
export const NucleoDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/nucleo' + location.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="reefoodTrazabilidadAppV3App.nucleo.delete.question">¿Seguro que quiere eliminar Nucleo {nucleoEntity.id}?</ModalBody>
      <ModalFooter>
