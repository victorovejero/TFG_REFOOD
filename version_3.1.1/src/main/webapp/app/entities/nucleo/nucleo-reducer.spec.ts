...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './nucleo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NUCLEO_LIST actions', async () => {
    ...
    it('dispatches FETCH_NUCLEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NUCLEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NUCLEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NUCLEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NUCLEO actions', async () => {
      const expectedActions = [
        {
