...
public class DonanteResource {
     ...
     *         body the new donanteDTO, or with status {@code 400 (Bad Request)} if
     *         the donante has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/donantes")
    public ResponseEntity<DonanteDTO> createDonante(@Valid @RequestBody DonanteDTO donanteDTO)
     ...
     *         the updated donanteDTO,
     *         or with status {@code 400 (Bad Request)} if the donanteDTO is not
     *         valid,
     *         or with status {@code 500 (Internal Server Error)} if the donanteDTO
     *         couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<DonanteDTO> updateDonante(
            ...
            @Valid @RequestBody DonanteDTO donanteDTO) throws URISyntaxException {
        ...
        return ResponseEntity
                ...
                .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME,
                        donanteDTO.getId().toString()))
                .body(result);
    }

    /**
     * {@code PATCH  /donantes/:id} : Partial updates given fields of an existing
     * donante, field will ignore if it is null
     *
     * @param id         the id of the donanteDTO to save.
     * @param donanteDTO the donanteDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     ...
     *         or with status {@code 400 (Bad Request)} if the donanteDTO is not
     *         valid,
     *         or with status {@code 404 (Not Found)} if the donanteDTO is not
     *         found,
     *         or with status {@code 500 (Internal Server Error)} if the donanteDTO
     *         couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
    ...
    public ResponseEntity<DonanteDTO> partialUpdateDonante(
            @PathVariable(value = "id", required = false) final Long id,
            @NotNull @RequestBody DonanteDTO donanteDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the donanteDTO, or with status {@code 404 (Not Found)}.
     */
