...
describe('Voluntario e2e test', () => {
  ...
  describe('new Voluntario page', () => {
    ...
    it('should create an instance of Voluntario', () => {
      ...
      cy.get(`[data-cy="fechaNacimiento"]`).type('2023-02-14').blur().should('have.value', '2023-02-14');

      cy.get(`[data-cy="sexo"]`).type('connect').should('have.value', 'connect');

      cy.get(`[data-cy="fechaAlta"]`).type('2023-02-15').blur().should('have.value', '2023-02-15');

      cy.get(`[data-cy="fechaBaja"]`).type('2023-02-14').blur().should('have.value', '2023-02-14');
