...
// Deletes entity created after each test.
  ...
  describe('new AlEnt page', () => {
    ...
    it('should create an instance of AlEnt', () => {
      ...
      cy.get(`[data-cy="fechaYHoraEntrada"]`).type('2023-01-15T13:58').blur().should('have.value', '2023-01-15T13:58');

      cy.get(`[data-cy="fechaYHoraRecogida"]`).type('2023-01-14T20:13').blur().should('have.value', '2023-01-14T20:13');

      cy.get(`[data-cy="fechaYHoraPreparacion"]`).type('2023-01-14T22:04').blur().should('have.value', '2023-01-14T22:04');
