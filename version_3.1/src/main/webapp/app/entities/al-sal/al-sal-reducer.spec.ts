...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './al-sal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALSAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_ALSAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ALSAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ALSAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ALSAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ALSAL actions', async () => {
      const expectedActions = [
        {
