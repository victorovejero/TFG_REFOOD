...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VOLUNTARIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_VOLUNTARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VOLUNTARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VOLUNTARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VOLUNTARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VOLUNTARIO actions', async () => {
      const expectedActions = [
        {
