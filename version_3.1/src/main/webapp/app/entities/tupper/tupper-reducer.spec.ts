...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tupper.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TUPPER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TUPPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TUPPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TUPPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TUPPER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TUPPER actions', async () => {
      const expectedActions = [
        {
