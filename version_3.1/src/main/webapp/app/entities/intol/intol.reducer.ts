...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IIntol, thunkAPI) => {
    const result = await axios.post<IIntol>(apiUrl, cleanEntity(entity));
...
export const updateEntity = createAsyncThunk(
  'intol/update_entity',
  async (entity: IIntol, thunkAPI) => {
    const result = await axios.put<IIntol>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IIntol, thunkAPI) => {
    const result = await axios.patch<IIntol>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    const result = await axios.delete<IIntol>(requestUrl);
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
