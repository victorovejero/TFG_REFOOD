...
export const AlEntDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/al-ent' + location.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="reefoodTrazabilidadAppV3App.alEnt.delete.question">¿Seguro que quiere eliminar Al Ent {alEntEntity.id}?</ModalBody>
      <ModalFooter>
