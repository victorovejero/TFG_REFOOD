...
public class TupperResource {
     ...
     *         body the new tupperDTO, or with status {@code 400 (Bad Request)} if
     *         the tupper has already an ID.
     ...
     *         the updated tupperDTO,
     *         or with status {@code 400 (Bad Request)} if the tupperDTO is not
     *         valid,
     *         or with status {@code 500 (Internal Server Error)} if the tupperDTO
     *         couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<TupperDTO> updateTupper(
            ...
            @Valid @RequestBody TupperDTO tupperDTO) throws URISyntaxException {
        ...
        return ResponseEntity
                ...
                .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME,
                        tupperDTO.getId().toString()))
                .body(result);
    }

    /**
     * {@code PATCH  /tuppers/:id} : Partial updates given fields of an existing
     * tupper, field will ignore if it is null
     *
     * @param id        the id of the tupperDTO to save.
     * @param tupperDTO the tupperDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
    ...
    public ResponseEntity<TupperDTO> partialUpdateTupper(
            @PathVariable(value = "id", required = false) final Long id,
            @NotNull @RequestBody TupperDTO tupperDTO) throws URISyntaxException {
     ...
     */
    @GetMapping("/tuppers")
    public ResponseEntity<List<TupperDTO>> getAllTuppers(
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the tupperDTO, or with status {@code 404 (Not Found)}.
     */
