...
/**
 * REST controller for managing {@link com.refood.trazabilidad.domain.FrutaYVerdura}.
 */
@RestController
@RequestMapping("/api")
public class FrutaYVerduraResource {
    ...
    public FrutaYVerduraResource(FrutaYVerduraService frutaYVerduraService, FrutaYVerduraRepository frutaYVerduraRepository) {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new frutaYVerduraDTO, or with status {@code 400 (Bad Request)} if the frutaYVerdura has already an ID.
    ...
    public ResponseEntity<FrutaYVerduraDTO> createFrutaYVerdura(@Valid @RequestBody FrutaYVerduraDTO frutaYVerduraDTO)
        ...
        if (frutaYVerduraDTO.getId() != null) {
            throw new BadRequestAlertException("A new frutaYVerdura cannot already have an ID", ENTITY_NAME, "idexists");
        }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated frutaYVerduraDTO,
     * or with status {@code 400 (Bad Request)} if the frutaYVerduraDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the frutaYVerduraDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/fruta-y-verduras/{id}")
    public ResponseEntity<FrutaYVerduraDTO> updateFrutaYVerdura(
        @PathVariable(value = "id", required = false) final Long id,
        @Valid @RequestBody FrutaYVerduraDTO frutaYVerduraDTO
    ) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, frutaYVerduraDTO.getId().toString()))
            .body(result);
    }

    /**
     * {@code PATCH  /fruta-y-verduras/:id} : Partial updates given fields of an existing frutaYVerdura, field will ignore if it is null
     *
     * @param id the id of the frutaYVerduraDTO to save.
     * @param frutaYVerduraDTO the frutaYVerduraDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated frutaYVerduraDTO,
     * or with status {@code 400 (Bad Request)} if the frutaYVerduraDTO is not valid,
     * or with status {@code 404 (Not Found)} if the frutaYVerduraDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the frutaYVerduraDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<FrutaYVerduraDTO> partialUpdateFrutaYVerdura(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody FrutaYVerduraDTO frutaYVerduraDTO
    ) throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, frutaYVerduraDTO.getId().toString())
        );
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of frutaYVerduras in body.
     */
    @GetMapping("/fruta-y-verduras")
    public ResponseEntity<List<FrutaYVerduraDTO>> getAllFrutaYVerduras(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the frutaYVerduraDTO, or with status {@code 404 (Not Found)}.
     */
