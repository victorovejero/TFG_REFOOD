...
import { getEntity, deleteEntity } from './checkout.reducer';
...
export const CheckoutDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="refoodTrazabilidadApp.checkout.delete.question">¿Seguro que quiere eliminar Checkout {checkoutEntity.id}?</ModalBody>
      <ModalFooter>
