...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './persona-beneficiaria.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSONABENEFICIARIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERSONABENEFICIARIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERSONABENEFICIARIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERSONABENEFICIARIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERSONABENEFICIARIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERSONABENEFICIARIA actions', async () => {
      const expectedActions = [
        {
