...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './registro.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REGISTRO_LIST actions', async () => {
    ...
    it('dispatches FETCH_REGISTRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REGISTRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REGISTRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REGISTRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REGISTRO actions', async () => {
      const expectedActions = [
        {
