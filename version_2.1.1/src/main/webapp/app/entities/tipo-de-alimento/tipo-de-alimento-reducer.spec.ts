...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPODEALIMENTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIPODEALIMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIPODEALIMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIPODEALIMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIPODEALIMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIPODEALIMENTO actions', async () => {
      const expectedActions = [
        {
