...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRUTAYVERDURA_LIST actions', async () => {
    ...
    it('dispatches FETCH_FRUTAYVERDURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FRUTAYVERDURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FRUTAYVERDURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FRUTAYVERDURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FRUTAYVERDURA actions', async () => {
      const expectedActions = [
        {
