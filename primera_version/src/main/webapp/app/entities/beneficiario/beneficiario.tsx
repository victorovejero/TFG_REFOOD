  ...
  return (
    <div>
      <h2 id="beneficiario-heading" data-cy="BeneficiarioHeading">
        <Translate contentKey="refoodTrazabilidadApp.beneficiario.home.title">Beneficiarios</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="refoodTrazabilidadApp.beneficiario.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/beneficiario/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="refoodTrazabilidadApp.beneficiario.home.createLabel">Create new Beneficiario</Translate>
          </Link>
        </div>
      </h2>
        ...
        {beneficiarioList && beneficiarioList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="refoodTrazabilidadApp.beneficiario.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('nombreBeneficiario')}>
                  <Translate contentKey="refoodTrazabilidadApp.beneficiario.nombreBeneficiario">Nombre Beneficiario</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('numPersonas')}>
                  <Translate contentKey="refoodTrazabilidadApp.beneficiario.numPersonas">Num Personas</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('numNinios')}>
                ...
                <th className="hand" onClick={sort('idDual')}>
                  <Translate contentKey="refoodTrazabilidadApp.beneficiario.idDual">Id Dual</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="refoodTrazabilidadApp.beneficiario.nucleo">Nucleo</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {beneficiarioList.map((beneficiario, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{beneficiario.numPersonas}</td>
                  <td>{beneficiario.numNinios}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="refoodTrazabilidadApp.beneficiario.home.notFound">No Beneficiarios found</Translate>
            </div>
          )
        )}
      </div>
