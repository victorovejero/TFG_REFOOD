  ...
  return (
    <div>
      <h2 id="registro-heading" data-cy="RegistroHeading">
        <Translate contentKey="refoodTrazabilidadApp.registro.home.title">Registros</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="refoodTrazabilidadApp.registro.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/registro/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="refoodTrazabilidadApp.registro.home.createLabel">Create new Registro</Translate>
          </Link>
        </div>
      </h2>
        ...
        {registroList && registroList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="refoodTrazabilidadApp.registro.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('ruta')}>
                  <Translate contentKey="refoodTrazabilidadApp.registro.ruta">Ruta</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="refoodTrazabilidadApp.registro.nucleo">Nucleo</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="refoodTrazabilidadApp.registro.home.notFound">No Registros found</Translate>
            </div>
          )
        )}
      </div>
