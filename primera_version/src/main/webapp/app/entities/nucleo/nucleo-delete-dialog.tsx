...
export const NucleoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="refoodTrazabilidadApp.nucleo.delete.question">
        <Translate contentKey="refoodTrazabilidadApp.nucleo.delete.question" interpolate={{ id: nucleoEntity.id }}>
          Are you sure you want to delete this Nucleo?
        </Translate>
      </ModalBody>
      <ModalFooter>
