...
export const VoluntarioDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="refoodTrazabilidadApp.voluntario.delete.question">
        <Translate contentKey="refoodTrazabilidadApp.voluntario.delete.question" interpolate={{ id: voluntarioEntity.id }}>
          Are you sure you want to delete this Voluntario?
        </Translate>
      </ModalBody>
      <ModalFooter>
