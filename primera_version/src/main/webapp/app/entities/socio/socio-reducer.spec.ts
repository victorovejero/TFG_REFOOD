...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './socio.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOCIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOCIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOCIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOCIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOCIO actions', async () => {
      const expectedActions = [
        {
