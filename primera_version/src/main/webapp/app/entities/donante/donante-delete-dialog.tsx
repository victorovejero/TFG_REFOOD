...
export const DonanteDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="refoodTrazabilidadApp.donante.delete.question">
        <Translate contentKey="refoodTrazabilidadApp.donante.delete.question" interpolate={{ id: donanteEntity.id }}>
          Are you sure you want to delete this Donante?
        </Translate>
      </ModalBody>
      <ModalFooter>
