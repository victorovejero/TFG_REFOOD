  ...
  return (
    <div>
      <h2 id="tupper-heading" data-cy="TupperHeading">
        <Translate contentKey="refoodTrazabilidadApp.tupper.home.title">Tuppers</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="refoodTrazabilidadApp.tupper.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/tupper/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="refoodTrazabilidadApp.tupper.home.createLabel">Create new Tupper</Translate>
          </Link>
        </div>
      </h2>
      <div className="table-responsive">
        <InfiniteScroll
          dataLength={tupperList ? tupperList.length : 0}
          next={handleLoadMore}
          ...
          {tupperList && tupperList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="refoodTrazabilidadApp.tupper.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('peso')}>
                    <Translate contentKey="refoodTrazabilidadApp.tupper.peso">Peso</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('productor')}>
                    <Translate contentKey="refoodTrazabilidadApp.tupper.productor">Productor</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('modelo')}>
                    <Translate contentKey="refoodTrazabilidadApp.tupper.modelo">Modelo</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('precio')}>
                    <Translate contentKey="refoodTrazabilidadApp.tupper.precio">Precio</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('descripcion')}>
                    <Translate contentKey="refoodTrazabilidadApp.tupper.descripcion">Descripcion</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="refoodTrazabilidadApp.tupper.home.notFound">No Tuppers found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
