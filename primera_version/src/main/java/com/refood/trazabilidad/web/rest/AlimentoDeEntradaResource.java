...
public class AlimentoDeEntradaResource {
    ...
    public ResponseEntity<AlimentoDeEntradaDTO> updateAlimentoDeEntrada(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, alimentoDeEntradaDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<AlimentoDeEntradaDTO> partialUpdateAlimentoDeEntrada(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, alimentoDeEntradaDTO.getId().toString())
        );
    }
