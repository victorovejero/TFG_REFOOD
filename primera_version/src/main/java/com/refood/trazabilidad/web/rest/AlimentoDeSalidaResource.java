...
public class AlimentoDeSalidaResource {
    ...
    public ResponseEntity<AlimentoDeSalidaDTO> updateAlimentoDeSalida(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, alimentoDeSalidaDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<AlimentoDeSalidaDTO> partialUpdateAlimentoDeSalida(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, alimentoDeSalidaDTO.getId().toString())
        );
    }
