...
public class DonanteResource {
    ...
    public ResponseEntity<DonanteDTO> updateDonante(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, donanteDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<DonanteDTO> partialUpdateDonante(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, donanteDTO.getId().toString())
        );
    }
