...
public class IntoleranciaResource {
    ...
    public ResponseEntity<IntoleranciaDTO> createIntolerancia(@RequestBody IntoleranciaDTO intoleranciaDTO) throws URISyntaxException {
    ...
    public ResponseEntity<IntoleranciaDTO> updateIntolerancia(
        ...
        @RequestBody IntoleranciaDTO intoleranciaDTO
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, intoleranciaDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<IntoleranciaDTO> partialUpdateIntolerancia(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, intoleranciaDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<IntoleranciaDTO>> getAllIntolerancias(
        @org.springdoc.api.annotations.ParameterObject Pageable pageable,
        @RequestParam(required = false, defaultValue = "false") boolean eagerload
    ) {
        log.debug("REST request to get a page of Intolerancias");
        Page<IntoleranciaDTO> page;
        if (eagerload) {
            page = intoleranciaService.findAllWithEagerRelationships(pageable);
        } else {
            page = intoleranciaService.findAll(pageable);
        }
