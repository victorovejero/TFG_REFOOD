...
public class RegistroResource {
    ...
    public ResponseEntity<RegistroDTO> updateRegistro(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, registroDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<RegistroDTO> partialUpdateRegistro(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, registroDTO.getId().toString())
        );
    }
