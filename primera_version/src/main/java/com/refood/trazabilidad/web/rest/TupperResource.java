...
public class TupperResource {
    ...
    public ResponseEntity<TupperDTO> updateTupper(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tupperDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TupperDTO> partialUpdateTupper(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tupperDTO.getId().toString())
        );
    }
