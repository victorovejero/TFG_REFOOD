...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './benef.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BENEF_LIST actions', async () => {
    ...
    it('dispatches FETCH_BENEF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BENEF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BENEF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BENEF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BENEF actions', async () => {
      const expectedActions = [
        {
