...
import { getEntities, reset } from './p-benef.reducer';
...
export const PBenef = () => {
  ...
  const links = useAppSelector(state => state.pBenef.links);
  const entity = useAppSelector(state => state.pBenef.entity);
  ...
  return (
    <div>
      ...
      <div className="table-responsive">
        <InfiniteScroll
          dataLength={pBenefList ? pBenefList.length : 0}
          next={handleLoadMore}
                  ...
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td className="text-end">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button tag={Link} to={`/p-benef/${pBenef.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                          <FontAwesomeIcon icon="pencil-alt" /> <span className="d-none d-md-inline">Editar</span>
                        </Button>
                        <Button tag={Link} to={`/p-benef/${pBenef.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
