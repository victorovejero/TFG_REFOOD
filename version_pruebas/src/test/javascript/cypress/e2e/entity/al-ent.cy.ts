...
describe('AlEnt e2e test', () => {
  ...
  const alEntSample = { peso: 35805, frutaYVerdura: false, fechaYHoraEntrada: '2023-01-15T07:33:31.220Z' };
  ...
  describe('new AlEnt page', () => {
    ...
    it('should create an instance of AlEnt', () => {
      ...
      cy.get(`[data-cy="fechaYHoraEntrada"]`).type('2023-01-15T07:59').blur().should('have.value', '2023-01-15T07:59');

      cy.get(`[data-cy="fechaYHoraRecogida"]`).type('2023-01-14T14:14').blur().should('have.value', '2023-01-14T14:14');

      cy.get(`[data-cy="fechaYHoraPreparacion"]`).type('2023-01-14T16:06').blur().should('have.value', '2023-01-14T16:06');
