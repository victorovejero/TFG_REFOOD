...
/**
 * REST controller for managing {@link com.refood.trazabilidad.domain.Voluntario}.
 */
@RestController
@RequestMapping("/api")
public class VoluntarioResource {
    ...
    public VoluntarioResource(VoluntarioService voluntarioService, VoluntarioRepository voluntarioRepository) {
    ...
    public ResponseEntity<VoluntarioDTO> createVoluntario(@Valid @RequestBody VoluntarioDTO voluntarioDTO) throws URISyntaxException {
    ...
    public ResponseEntity<VoluntarioDTO> updateVoluntario(
        ...
        @Valid @RequestBody VoluntarioDTO voluntarioDTO
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, voluntarioDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<VoluntarioDTO> partialUpdateVoluntario(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody VoluntarioDTO voluntarioDTO
    ) throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, voluntarioDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<VoluntarioDTO>> getAllVoluntarios(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Voluntarios");
