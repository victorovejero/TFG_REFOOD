...
/**
 * REST controller for managing {@link com.refood.trazabilidad.domain.AlimentoDeSalida}.
 */
@RestController
@RequestMapping("/api")
public class AlimentoDeSalidaResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new alimentoDeSalidaDTO, or with status {@code 400 (Bad Request)} if the alimentoDeSalida has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/alimento-de-salidas")
    public ResponseEntity<AlimentoDeSalidaDTO> createAlimentoDeSalida(@Valid @RequestBody AlimentoDeSalidaDTO alimentoDeSalidaDTO)
        throws URISyntaxException {
        log.debug("REST request to save AlimentoDeSalida : {}", alimentoDeSalidaDTO);
        if (alimentoDeSalidaDTO.getId() != null) {
            throw new BadRequestAlertException("A new alimentoDeSalida cannot already have an ID", ENTITY_NAME, "idexists");
        }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated alimentoDeSalidaDTO,
     * or with status {@code 400 (Bad Request)} if the alimentoDeSalidaDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the alimentoDeSalidaDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<AlimentoDeSalidaDTO> updateAlimentoDeSalida(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, alimentoDeSalidaDTO.getId().toString()))
            .body(result);
    }

    /**
     * {@code PATCH  /alimento-de-salidas/:id} : Partial updates given fields of an existing alimentoDeSalida, field will ignore if it is null
     *
     * @param id the id of the alimentoDeSalidaDTO to save.
     * @param alimentoDeSalidaDTO the alimentoDeSalidaDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated alimentoDeSalidaDTO,
     * or with status {@code 400 (Bad Request)} if the alimentoDeSalidaDTO is not valid,
     * or with status {@code 404 (Not Found)} if the alimentoDeSalidaDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the alimentoDeSalidaDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/alimento-de-salidas/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<AlimentoDeSalidaDTO> partialUpdateAlimentoDeSalida(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody AlimentoDeSalidaDTO alimentoDeSalidaDTO
    ) throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, alimentoDeSalidaDTO.getId().toString())
        );
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of alimentoDeSalidas in body.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the alimentoDeSalidaDTO, or with status {@code 404 (Not Found)}.
     */
