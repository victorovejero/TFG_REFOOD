...
public class NucleoResource {
    ...
    public ResponseEntity<NucleoDTO> updateNucleo(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, nucleoDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<NucleoDTO> partialUpdateNucleo(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, nucleoDTO.getId().toString())
        );
    }
