...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BENEFICIARIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_BENEFICIARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BENEFICIARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BENEFICIARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BENEFICIARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BENEFICIARIO actions', async () => {
      const expectedActions = [
        {
