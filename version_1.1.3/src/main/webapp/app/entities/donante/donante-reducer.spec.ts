...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './donante.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DONANTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DONANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DONANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DONANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DONANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DONANTE actions', async () => {
      const expectedActions = [
        {
