...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './alimento-de-salida.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALIMENTODESALIDA_LIST actions', async () => {
    ...
    it('dispatches FETCH_ALIMENTODESALIDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ALIMENTODESALIDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ALIMENTODESALIDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ALIMENTODESALIDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ALIMENTODESALIDA actions', async () => {
      const expectedActions = [
        {
