...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTOLERANCIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_INTOLERANCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTOLERANCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTOLERANCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTOLERANCIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTOLERANCIA actions', async () => {
      const expectedActions = [
        {
