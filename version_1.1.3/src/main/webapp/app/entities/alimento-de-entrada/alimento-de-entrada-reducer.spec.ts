...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './alimento-de-entrada.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALIMENTODEENTRADA_LIST actions', async () => {
    ...
    it('dispatches FETCH_ALIMENTODEENTRADA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ALIMENTODEENTRADA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ALIMENTODEENTRADA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ALIMENTODEENTRADA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ALIMENTODEENTRADA actions', async () => {
      const expectedActions = [
        {
